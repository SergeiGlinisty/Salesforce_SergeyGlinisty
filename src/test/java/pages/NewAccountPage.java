...
public class NewAccountPage extends BasePage {
    ...
    public final static By TYPE_BUTTON = By.xpath("//a[@class='select']/ancestor::div[@class='isModal inlinePanel oneRecordActionWrapper']");
    public final static By TYPE = By.xpath("//a[@role='menuitemradio' and text()='Other']");
